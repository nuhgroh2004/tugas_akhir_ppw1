          ...
          <div class="col-lg-6 col-md-6">
            <div class="single_event position-relative">
              ...
              <div class="event_details">
                ...
                <p>
                  PPDB 2024 SMA AL-irsyad Kota Tegal, segera daftarkan diri anda sebelum kuota penuh.
                </p>
                <a href="about-sudah-login.html" class="primary-btn rounded-0 mt-3">View Details</a>
              </div>
            </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="single_event position-relative">
              ...
              <div class="event_details">
                ...
                <p>
                    Pertukaran dengan siswa dari luar negeri, segera daftarkan diri anda sebelum kuota penuh.
                </p>
                <a href="about-sudah-login.html" class="primary-btn rounded-0 mt-3">View Details</a>
              </div>
            </div>
